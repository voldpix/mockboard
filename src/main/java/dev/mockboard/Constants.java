...
public final class Constants {
    ...
    // rate limiter
    public static final int RATE_LIMIT_MAX_BOARDS_PER_HOUR = 3;
    public static final int RATE_LIMIT_MAX_MOCK_EXECUTIONS_PER_MINUTE = 30;
    public static final int RATE_LIMIT_MAX_OTHER_REQUESTS_PER_MINUTE = 80;
